...
namespace ExpressSolution.Stores.Data.Migrations
{
    ...
    [Migration("20210627044208_AddlistOfCategoryToStore")]
    partial class AddlistOfCategoryToStore
    {
            ...
            modelBuilder.Entity("ExpressSolution.Stores.Store", b =>
                {
                    ...
                    b.OwnsMany("ExpressSolution.Stores.StoreCategory", "StoreCategories", b1 =>
                        {
                            b1.Property<string>("CategoryId")
                                .HasMaxLength(50)
                                .HasColumnType("nvarchar(50)");
                            ...
                            b1.HasKey("CategoryId", "StoreId");

                            b1.HasIndex("StoreId");

                            b1.ToTable("StoreCategory");

                            b1.HasOne("ExpressSolution.Stores.Category", "Category")
                                .WithMany()
                                .HasForeignKey("CategoryId")
