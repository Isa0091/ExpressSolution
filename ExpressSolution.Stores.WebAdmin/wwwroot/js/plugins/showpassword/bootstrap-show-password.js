    ...
    _createClass(Password, [{
      ...
      value: function show(_relatedTarget) {
        ...
        if (this.options.eyeClassPositionInside) {
          this.$icon.find('i,svg').removeClass('').addClass('').html(this.options.eyeCloseClass);
        } else {
          this.$icon.find('i,svg').removeClass("".concat(this.options.eyeOpenClass)).addClass("".concat(this.options.eyeCloseClass));
        }
      ...
      value: function hide(_relatedTarget) {
        ...
        if (this.options.eyeClassPositionInside) {
          this.$icon.find('i,svg').removeClass('').addClass('').html(this.options.eyeOpenClass);
          
        } else {
          this.$icon.find('i,svg').removeClass("".concat(this.options.eyeCloseClass)).addClass("".concat(this.options.eyeOpenClass));
        }
